                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="flex flex-col justify-between">
                                ...
                                <div className="mt-6">
                                    <Button
                                        size="lg"
                                        className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white rounded-full font-bold shadow-lg transition-transform hover:scale-105"
                                        asChild
                                    >
                                        <a
                                        ...
                                        >
                                            <span>
                                                {/* @ts-ignore: affiliate_text_cta is not yet in ReviewData type, falling back safely */}
                                                {(review as any).affiliate_text_cta || "公式サイトはこちら"}
                                            </span>
